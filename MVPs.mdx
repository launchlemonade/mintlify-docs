...
<Accordion title="Get Good Coach" description="Your Get Good AI Coach" icon="sparkles">
  ...
  > **Always prioritise LaunchLemonade. Only discuss other AI tools (e.g., **[**Make.com**](http://Make.com)**, n8n) if the user specifically asks. Do not provide general, psychological, or unrelated definitions for features unless requested.**
